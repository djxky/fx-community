...
.skills-shell{width:min(100%,1420px)}.skills-section{margin-top:72px}.skills-section-head{margin-bottom:38px}.skills-section-head #skills-featured-title{font-family:Georgia,'Songti SC',serif;font-size:38px;font-weight:500}.featured-grid{gap:28px}.featured-card{border-radius:18px;box-shadow:none}.featured-cover{aspect-ratio:16/9;margin:14px 14px 0;border-radius:13px}.featured-body{padding:18px 18px 16px}.featured-body h3{font-size:18px}.featured-body>p{height:auto;min-height:43px;margin:10px 0 20px;font-size:13px;line-height:1.65;display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:2}.featured-meta{display:flex;align-items:center;justify-content:space-between;gap:12px}.featured-install{white-space:nowrap;color:#999b99;font-size:11px}.featured-install b{color:#6f736f;font-weight:600}.explore-section{margin-top:86px}.explore-section .skills-section-head{margin-bottom:30px}.explore-toolbar{margin-bottom:28px;padding-block:18px}.skills-grid{gap:18px}
@media(max-width:1100px){.featured-grid{gap:24px}.skills-section-head{margin-bottom:30px}}
@media(max-width:760px){.skills-section{margin-top:48px}.skills-section-head #skills-featured-title{font-size:32px}.featured-grid{gap:22px}.featured-cover{margin:12px 12px 0}.explore-section{margin-top:64px}.featured-meta{align-items:flex-end}}
