...
const TYPE_LABEL = { press: '出版社', research: '教研组', school: '名校', studio: '工作室' }
</script>
    ...
    <div class="mc-top">
      ...
      <div class="mc-head">
        <div class="mc-name">
          ...
          <span v-else class="mc-type">{{ TYPE_LABEL[m.kind] }}</span>
        </div>
        <div class="mc-cred">{{ m.cred }}</div>
      </div>
    </div>
