...
export const POSTS = [
  ...
  {
    to: 'res', cover: EDITORIAL_COVERS.courseAuthoring, badge: '备课 · AI 工具', live: false,
  ...
  {
    to: 'res', cover: EDITORIAL_COVERS.teacherCollaboration, badge: '班级 · 沟通模板', live: false,
    scene: 'classcare', task: 'home-school', subject: '全学科', stage: '通用', form: '沟通模板',
    author: '王芳', avatar: '王', role: '深圳南山实验学校', verify: 'teacher',
    title: '把零散的家校沟通整理成一张成长记录，老师、学生和家长都知道下一步做什么',
    proof: { type: 'comment', text: '沟通不再只停留在群消息里' },
    meta: '全学科 · 家校沟通 · 沟通模板', verified: false,
    evi: { use: '438', adapt: '22', star: '1,160' }, views: '5,600',
  },
]
