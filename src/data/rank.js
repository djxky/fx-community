...
export const BOARDS = [
  ...
  {
    key: 'latest', group: 'resource', title: '每周热门', tag: '本周', hot: false,
    period: '按本周使用排序', metricLabel: '位老师使用', desc: '本周被老师用得最多的课堂资源，不看上架早晚。', layout: 'feature',
    items: [
  ...
  {
    key: 'recognized', group: 'creator', title: '创作达人榜', tag: '综合', hot: false,
    period: '按作品数与使用量综合排序', metricLabel: '位老师使用', desc: '作品多、又被老师持续带进课堂的创作者。', layout: 'editorial-work',
    items: [
      creatorEntry(WORKS.mathCodesign, '46,200', { metricNote: '18 件作品' }),
      creatorEntry(WORKS.printingPress, '38,400', { metricNote: '16 件作品' }),
      creatorEntry(WORKS.algorithmKitchen, '32,100', { metricNote: '14 件作品' }),
      creatorEntry(WORKS.courseAuthoring, '24,600', { metricNote: '12 件作品' }),
      creatorEntry(WORKS.evidencePoetry, '20,300', { metricNote: '10 件作品' }),
      creatorEntry(WORKS.musicWave, '15,400', { metricNote: '9 件作品' }),
      creatorEntry(WORKS.historyRoute, '11,200', { metricNote: '7 件作品' }),
      creatorEntry(WORKS.projectileLab, '8,600', { metricNote: '6 件作品' }),
      creatorEntry(WORKS.crystalModel, '5,200', { metricNote: '4 件作品' }),
      creatorEntry(WORKS.learningAnalytics, '3,100', { metricNote: '3 件作品' }),
    ],
  },
  {
    key: 'rising', group: 'creator', title: '新锐创作者榜', tag: '新锐', hot: false,
    period: '按近30天使用排序', metricLabel: '位老师使用', desc: '入驻不久的新人，近期作品已经被很多老师带进课堂。', layout: 'work-rail',
    items: [
      creatorEntry(WORKS.historyRoute, '1,240', { workTitle: '祥林嫂 · 县中简化版', unit: '位老师使用' }),
      creatorEntry(WORKS.projectileLab, '980', { unit: '位老师使用' }),
      creatorEntry(WORKS.orderGame, '760', { unit: '位老师使用' }),
      creatorEntry(WORKS.courseAuthoring, '620', { unit: '位老师使用' }),
      creatorEntry(WORKS.learningAnalytics, '540', { unit: '位老师使用' }),
      creatorEntry(WORKS.crystalModel, '460', { unit: '位老师使用' }),
      creatorEntry(WORKS.algorithmKitchen, '380', { unit: '位老师使用' }),
      creatorEntry(WORKS.evidencePoetry, '320', { unit: '位老师使用' }),
      creatorEntry(WORKS.immersiveText, '260', { unit: '位老师使用' }),
      creatorEntry(WORKS.xianglin, '210', { unit: '位老师使用' }),
    ],
  },
]
