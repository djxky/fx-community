...
export const FEED = [
  {
    ...
    resource: { to: 'res', title: '圆的面积·同步题单', meta: '小学数学 · 六年级 · 人教版', cover: COVERS[3], use: '1,240', save: '3,420', scene: 'assessment', task: 'homework', subject: '数学', stage: '小学', form: '题单' },
  ...
  },
  {
    ...
    resource: { to: 'res', title: '六年级下·单元整体设计', meta: '小学数学 · 六年级 · 单元设计', cover: COVERS[9], use: '3.2万', save: '5.8万', scene: 'prep', task: 'design', subject: '数学', stage: '小学', form: '教案' },
  ...
  },
  {
    ...
    resource: { to: 'res', title: '跨学科·数学建模', meta: '初中数学 · 校本课 · 项目学习', cover: COVERS[2], use: '986', save: '2,760', scene: 'research', task: 'co-planning', subject: '数学', stage: '初中', form: '教案' },
  ...
  },
  {
    ...
    resource: { to: 'res', title: '我把《祝福》上成一场庭审 · 祥林嫂剧本杀', meta: '初中语文 · 九年级 · 统编版', cover: COVERS[0], use: '1,240', save: '3,420', scene: 'classroom', task: 'interact', subject: '语文', stage: '初中', form: '教学游戏' },
  ...
  },
  {
    ...
    resource: { to: 'res', title: '陈红《点餐口语游戏》', meta: '初中英语 · 口语 · 游戏化', cover: COVERS[4], use: '1,530', save: '4,100', scene: 'classroom', task: 'practice', subject: '英语', stage: '初中', form: '教学游戏' },
  ...
  },
  {
    ...
    resource: { to: 'res', title: '《桃花源记》课例 · V6', meta: '初中语文 · 八年级 · 文言文', cover: COVERS[8], use: '902', save: '2,510', scene: 'research', task: 'co-planning', subject: '语文', stage: '初中', form: '教案' },
  ...
  },
  {
    ...
    resource: { to: 'res', title: '圆柱体积·天坛拆柱', meta: '小学数学 · 六年级 · 人教版', cover: COVERS[6], use: '986', save: '2,760', scene: 'classroom', task: 'explain', subject: '数学', stage: '小学', form: '互动课件' },
  ...
  },
  {
    ...
    resource: { to: 'res', title: '分层作业·一课三练', meta: '小学英语 · 三年级 · 课堂练习', cover: COVERS[1], use: '405', save: '1,240', scene: 'assessment', task: 'homework', subject: '英语', stage: '小学', form: '题单' },
  ...
  },
  {
    ...
    resource: { to: 'res', title: '口算挖金矿·课堂版', meta: '小学数学 · 口算 · 游戏化', cover: COVERS[6], use: '902', save: '2,510', scene: 'classroom', task: 'practice', subject: '数学', stage: '小学', form: '教学游戏' },
